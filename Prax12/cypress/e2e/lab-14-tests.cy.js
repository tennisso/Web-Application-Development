...
it('Testing the sign up form when password is not valid', () => {
    ...
    // ----- Your code goes here
    cy.get('input[name="email"]').type('name@ut.ee');
...
it("Get a post based on its id", function() {
    let postId = 4 //Change the value to an id of a post in your database
...
it("Update a post request", function() {
    // ----- Your code goes here
    cy.request("Put", "http://localhost:3000/api/posts/2", {
